...
##################################################
#                                                #
# Purpose: Install and configure glance image    #
#          service                               #
...
echo "########################################################################################"
echo;
echo "Please provide glance user database password, also update ~/.password file."
echo;
echo "########################################################################################"
read GLANCE_DBPASS
...
GLANCE_DBPASS=$(cat ~/.password | awk '/GLANCE_DBPASS/ {print $3}')
GLANCE_PASS=$(cat ~/.password | awk '/GLANCE_PASS/ {print $3}')
...
openstack endpoint create --region RegionOne \
  image public http://$controller_name:9292

openstack endpoint create --region RegionOne \
  image internal http://$controller_name:9292

openstack endpoint create --region RegionOne \
  image admin http://$controller_name:9292
...
echo "##############################################################################################"
echo;
echo " Glance Image service is added."
echo;
echo "##############################################################################################"
echo;