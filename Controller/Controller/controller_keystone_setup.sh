...
##################################################
#                                                #
# Purpose: Install and configure Keystone        #
#          Identity service                      #
...
echo "########################################################################################"
echo;
echo "Please provide MARIADB password in ~/.password file."
echo;
echo "########################################################################################"
read MARIADB_PASS
...
echo "########################################################################################"
echo;
echo "Please provide KEYSTONE_DB password in ~/.password file."
echo;
echo "########################################################################################"
...
KEYSTONE_DBPASS=$(cat ~/.password | awk '/KEYSTONE_DBPASS/ {print $3}')
...
apt-get install keystone apache2 libapache2-mod-wsgi \
  memcached python-memcache --force-yes -y

# configure keystone components
...
# value)
#admin_token = ADMIN
admin_token = a9d340b637594eaa9fa7
...
connection = mysql+pymysql://keystone:$KEYSTONE_DBPASS@$controller_name/keystone
...
echo "##############################################################################################"
echo;
echo "Keystone installation and configuration is done."
echo;
echo "##############################################################################################"
echo;
