...
connection = mysql+pymysql://neutron:$NEUTRON_DBPASS@$controller_name/neutron
...
echo "##############################################################################################"
echo;
echo "Installation and configuration of Self-service networks in controller node is done."
echo;
echo "##############################################################################################"
echo;