...
apt-get update
# Install NTP chrony on Compute node
apt-get install chrony -y
cp /etc/chrony/chrony.conf /etc/chrony/chrony.conf.orig

# Change /etc/chrony/chrony.conf file
...
# server 3.debian.pool.ntp.org offline minpoll 8a

server $controller_name iburst
...
echo "##############################################################################################"
echo;
echo "Chrony setup in "$compute_name" node is done."
echo;
echo "##############################################################################################"
echo;